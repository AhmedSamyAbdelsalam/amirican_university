...
use App\Http\Resources\General\CentersResource;
...
class GeneralController extends Controller
{
    ...
    public function center(){
        $center = Center::active()->orderBy('id', 'desc')->get();

        if ($center->count() > 0) {
            return CentersResource::collection($center);
        } else {
            return response()->json(['error' => true, 'message'=> 'No Centers found'], 201);
        }
    }
