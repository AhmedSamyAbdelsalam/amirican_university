...
@section('content')
    ...
    <div class="col-lg-12 col-12">
        ...
        {!! Form::open(['route' => 'admin.update_info', 'name' => 'user_info', 'id' => 'user_info', 'method' => 'post', 'files' => true]) !!}
        <div class="row">
            <div class="col-3">
        ...
        {!! Form::open(['route' => 'admin.update_password', 'name' => 'user_password', 'id' => 'user_password', 'method' => 'post']) !!}
        <div class="row">
            <div class="col-4">
                <div class="form-group">
